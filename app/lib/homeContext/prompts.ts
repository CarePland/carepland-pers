...
export const homeContextDefaultUserPrompt =
  "Use the supplied user question, query interpretation, Ask context, visibleItems, and CarePland context. Answer naturally and briefly. Name the active topic, appointment, provider, or document when available. If the query was shorthand or ambiguous, state the interpretation briefly. Explain what the saved record suggests, not every data point.";
