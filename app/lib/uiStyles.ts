export const gentlePrimaryButtonClass =
...
export const gentleSecondaryButtonClass =
...
export const gentleSoftBlueButtonClass =
...
export const gentleSmallBlueButtonClass =
...
export const gentleSmallSecondaryButtonClass =
...
export const gentleCautionButtonClass =
...
export const gentleWarmButtonClass =
...
export const gentleTextButtonClass =
  "rounded-md px-2 py-1 text-sm font-semibold text-blue-700 transition hover:bg-blue-100/70 hover:text-blue-900";

export const appointmentSectionButtonClass =
...
export const appointmentSectionTitleButtonClass =
...
export const appointmentToolIconButtonClass =
