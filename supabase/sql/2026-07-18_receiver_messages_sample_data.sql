-- Adds a durable Receiver + Messages demo layer on top of the Health Focus and
-- meaning/action sample data. This lets seeded accounts exercise Receiver
-- attachment, message lifecycle, appointment-linked MessagePrep, interaction
-- review, calls, and admin operational queues without Android hardware.
